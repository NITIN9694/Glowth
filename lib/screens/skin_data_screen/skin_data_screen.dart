            ...
            child: Obx(
              () => Column(
                ...
                children: [
                  ...
                  SizedBox(height: 15.h),
                  if (controller.visibleStep.value >= 1)
                    Column(
                      mainAxisAlignment: MainAxisAlignment.start,
                      crossAxisAlignment: CrossAxisAlignment.start,
                  ...
                  SizedBox(height: 5.h),
                  if (controller.visibleStep.value >= 2)
                    Column(
                      mainAxisAlignment: MainAxisAlignment.start,
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                  ...
                  if (controller.visibleStep.value >= 3)
                    Column(
                      mainAxisAlignment: MainAxisAlignment.start,
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                  ...
                  if (controller.visibleStep.value >= 4)
                    Column(
                      mainAxisAlignment: MainAxisAlignment.start,
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                  ...
                  if (controller.visibleStep.value >= 5)
                    Column(
                      mainAxisAlignment: MainAxisAlignment.start,
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
