...
// Background	Warm Porcelain	#F5F3EF	App background
// Surface Cards	Misty Taupe	#E0DCD5	Cards, modals, product previews
// Accent	Sage Gray-Green	#9BA3A0	Subtle wellness vibe, tags, progress bars
// Success/Glow	Soft Honey Glow	#F6E2B3	For glow indicators, product matches
// Text (Primary)	Rich Charcoal Black	#1C1C1C	Main body text
// Text (Secondary)	Smokey Ash	#6D6D6D	Placeholder, hint text
...
class AppColors{
  ...
  // Secondary - Onyx Black
  static const Color onyxBlack = Color(0xFF121212);

  // Surface - Slate Ash
  static const Color slateAsh = Color(0xFF2E2E2E);

  // Accent - Cool Sage
  static const Color coolSage = Color(0xFF9AA59D);

  // Glow Indicator - Amber Veil
  static const Color amberVeil = Color(0xFFE6C188);

  // Text Colors
  static const Color textPrimary = Color(0xFFF3F3F3); // Pearl White
  static const Color textSecondary = Color(0xFFB3B3B3); // Mist Gray
}